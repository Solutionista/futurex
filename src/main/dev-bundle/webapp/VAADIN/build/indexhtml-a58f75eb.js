...
`,x=class extends te{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus="unavailable",this.javaStatus="unavailable",this.tabs=[{id:"log",title:"Log",render:this.renderLog,activate:this.activateLog},{id:"info",title:"Info",render:this.renderInfo},{id:"features",title:"Feature Flags",render:this.renderFeatures}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.nextMessageId=1,this.transitionDuration=0,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:this.renderCode})}static get styles(){return[b`
    ...
    `}render(){return R` <div
      ...
      <div>
        ...
        <button
          class="button pick"
          @click=${()=>{this.componentPickActive=!0,He(()=>import("./component-picker-d2b9bf45.js"),["./component-picker-d2b9bf45.js","./custom-element-1c6555a1.js"],import.meta.url)}}
        >
...
`;ke("",ti,{moduleId:"lumo-typography"});const oi=document.createElement("template");oi.innerHTML=`<style>${rr.toString().replace(":host","html")}</style>`;document.head.appendChild(oi.content);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const sr=b`
...
`,ii=document.createElement("template");ii.innerHTML=`<style>${sr.toString().replace(":host","html")}</style>`;document.head.appendChild(ii.content);const ni=b`
  [theme~='dark'] {
    /* Base (background) */
...
`;const ai=document.createElement("template");ai.innerHTML=`<style>${ar.toString().replace(":host","html")}$</style>`;document.head.appendChild(ai.content);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const li=b`
